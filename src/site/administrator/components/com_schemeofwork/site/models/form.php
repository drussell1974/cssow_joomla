 ...
 * @since  0.0.1
 */
class SchemeOfWorkModelForm extends JModelAdmin
{
...
/**
     ...
     * This returns the script associated with schemeofwork field schemeofwork validation
     *
     * @return string	Script files
     */
    public function getScript() 
    {
        return 'administrator/components/com_schemeofwork/models/forms/schemeofwork.js';
    }
}