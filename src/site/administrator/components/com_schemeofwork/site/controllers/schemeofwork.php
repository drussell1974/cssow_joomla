...
{   
    ...
    /*
     * Function handing the save for adding a new schemeofwork record
    ...
    public function save($key = null, $urlVar = null)
    {
        ...
        if (!JFactory::getUser()->authorise( "core.create", "com_schemeofwork"))
        {
        ...
        $mailer->setSubject("New schemeofwork added by " . $current_username);
        $mailer->setBody("New schemeofwork is " . $validData['schemeofwork']);
        try 
        {
            $mailer->send(); 
        }
