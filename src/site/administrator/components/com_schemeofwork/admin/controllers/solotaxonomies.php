...
class SchemeOfWorkControllerSoloTaxonomies extends JControllerAdmin {
    ...
    public function delete(){
        ...
        $model = $this->getModel('SoloTaxonomy', 'SchemeOfWorkModel');
        $model->delete($recs);
        $msg = JText::sprintf('COM_SCHEMEOFWORK_SOLOTAXONOMY_N_ITEMS_DELETED' ,$nrecs);
        //... then redirect to the same page
        
        $this->setRedirect(JRoute::_('index.php?option=com_schemeofwork&view=solotaxonomies', false), $msg);
    }
