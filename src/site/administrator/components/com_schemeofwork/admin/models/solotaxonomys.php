...
class SchemeOfWorkModelSoloTaxonomys extends JModelList {
    ...
    protected function getListQuery() {
        ...
        $query->select($db->quoteName('u.username', 'author'))
                ->join('LEFT', $db->quoteName('#__users', 'u') . ' ON u.id = solo.created_by');
        ...
        if (!empty($search)) {
            ...
            $query->where('solo.name LIKE ' . $like);
        }
        ...
        \JLog::add("SchemeOfWorkModelSoloTaxonomy.getListQuery=" . $query, \JLog::DEBUG, \JText::_('LOG_CATEGORY'));
