...
class SchemeOfWorkViewSoloTaxonomies extends JViewLegacy {
    ...
    function display($tpl = null) {
        ...
        // Set the submenu
        SchemeOfWorkHelper::addSubmenu('solotaxonomies');
    ...
    protected function addToolBar() {
        $title = JText::_('COM_SCHEMEOFWORK_SOLOTAXONOMY_MANAGER');
        ...
        //{
        JToolbarHelper::addNew('solotaxonomy.add');
        //}
        //if ($this->canDo->get('core.edit')) 
        //{
        JToolbarHelper::editList('solotaxonomy.edit');
        //}
