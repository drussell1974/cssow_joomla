...
/**
 * LearningObjectiveHasPathway View
 *
 * @since  0.0.1
 */
class SchemeOfWorkViewLearningObjectiveHasPathways extends JViewLegacy {
    ...
    function display($tpl = null) {
        ...
        // Set the submenu
        SchemeOfWorkHelper::addSubmenu('learningobjectivehaspathways');
    ...
    protected function addToolBar() {
        $title = JText::_('COM_SCHEMEOFWORK_LEARNINGOBJECTIVEHASPATHWAY_MANAGER');
        ...
        //{
        JToolbarHelper::addNew('learningobjectivehaspathway.add');
        //}
        //if ($this->canDo->get('core.edit')) 
        //{
        JToolbarHelper::editList('learningobjectivehaspathway.edit');
        //}
        //if ($this->canDo->get('core.delete')) 
        //{
        JToolbarHelper::deleteList('', 'learningobjectivehaspathways.delete');
        //}
