 ...
 * @since  0.0.1
 */
class SchemeOfWorkViewExamBoards extends JViewLegacy {
    ...
    function display($tpl = null) {
        ...
        // Set the submenu
        SchemeOfWorkHelper::addSubmenu('examboards');
    ...
    protected function addToolBar() {
        $title = JText::_('COM_SCHEMEOFWORK_EXAMBOARD_MANAGER');
        ...
        //{
        JToolbarHelper::addNew('examboard.add');
        //}
        //if ($this->canDo->get('core.edit')) 
        //{
        JToolbarHelper::editList('examboard.edit');
        //}
        //if ($this->canDo->get('core.delete')) 
        //{
        JToolbarHelper::deleteList('', 'examboards.delete');
        //}
