...
?>
<form action="index.php?option=com_schemeofwork&view=subjectpurposes" method="post" id="adminForm" name="adminForm">
    ...
    <div id="j-main-container" class="span10">   
        <div class="row-fluid">
            <div class="span6">
                <?php echo JText::_('COM_SCHEMEOFWORK_SUBJECTPURPOSE_FILTER'); ?>
                <?php
...
<?php if (!empty($this->items)) : ?>
                    ...
                    foreach ($this->items as $i => $row) :
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_SCHEMEOFWORK_SUBJECTPURPOSE_EDIT'); ?>">
                                    <?php echo $row->name; ?>
                                </a>
                            </td>
                            <td align="center">
                            ...
                            <td align="center">
                                <?php echo JHtml::_('jgrid.published', $row->published, $i, 'subjectpurposes.', true, 'cb'); ?>
                            </td>
                            <td align="center">
                                <?php echo $row->id; ?>
                            </td>
