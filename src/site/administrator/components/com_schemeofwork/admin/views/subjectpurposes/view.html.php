...
/**
 * SubjectPurposes View
 *
 * @since  0.0.1
 */
class SchemeOfWorkViewSubjectPurposes extends JViewLegacy {
    ...
    function display($tpl = null) {
        ...
        // Set the submenu
        SchemeOfWorkHelper::addSubmenu('subjectpurposes');
    ...
    protected function addToolBar() {
        $title = JText::_('COM_SCHEMEOFWORK_SUBJECTPURPOSE_MANAGER');
        ...
        //{
        JToolbarHelper::addNew('subjectpurpose.add');
        //}
        //if ($this->canDo->get('core.edit')) 
        //{
        JToolbarHelper::editList('subjectpurpose.edit');
        //}
        //if ($this->canDo->get('core.delete')) 
        //{
        JToolbarHelper::deleteList('', 'subjectpurposes.delete');
        //}
