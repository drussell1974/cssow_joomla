...
/**
 * LearningObjective View
 *
 * @since  0.0.1
 */
class SchemeOfWorkViewLearningObjectives extends JViewLegacy {
    ...
    function display($tpl = null) {
        ...
        // Set the submenu
        SchemeOfWorkHelper::addSubmenu('learningobjectives');
    ...
    protected function addToolBar() {
        $title = JText::_('COM_SCHEMEOFWORK_LEARNINGOBJECTIVE_MANAGER');
        ...
        //{
        JToolbarHelper::addNew('learningobjective.add');
        //}
        //if ($this->canDo->get('core.edit')) 
        //{
        JToolbarHelper::editList('learningobjective.edit');
        //}
        //if ($this->canDo->get('core.delete')) 
        //{
        JToolbarHelper::deleteList('', 'learningobjectives.delete');
        //}
